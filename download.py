...
def main(args):
    print(f'getting values from {args.tablename} between {args.begin} and {args.end}')
    t0, t1 = get_time_stamps(args)
    curl_string = get_curl_string(args.tablename, t0, t1)
    print(f'curl string:\n{curl_string}')
...
if __name__ == '__main__':
    ...
    parser.add_argument("--begin", type=str, default='2018-10-16-19', help="date from which data is retreived")
    parser.add_argument("--end", type=str, default='2018-10-16-20', help="date to which data is retreived")
